    ...
    <div class="footer-content">
      ...
      <div class="footer-item beian">
        ...
        <div class="beian-info">
          ...
          <a href="#" target="_blank">桂公网安备 xxxxxx号</a>
        </div>
      </div>

      <!-- 赞助支持 -->
      <div class="footer-item sponsor">
        <a href="#" target="_blank">成为赞助者</a>
        <a href="#" target="_blank">打赏支持</a>
        <a href="#" target="_blank">项目合作</a>
      </div>

      <!-- 友情链接 -->
      <div class="footer-item friend-links">
        <a href="#" target="_blank">掘金</a>
